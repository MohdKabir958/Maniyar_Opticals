        ...
        <>
                ...
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-24 mx-auto">
                        ...
                        {/* Maniyar_Opt\public\frame-img_home\deena-englard-RJrCj87zPJc-unsplash. */}
                            ...
                            <FrameCard src="/frame-img_home/masjid-maba-bsdHN-QPajo-unsplash.jpg" loading="lazy" />
                            <FrameCard src="/frame-img_home/mir-ismamul-karim--CqbjEPj6Q8-unsplash.jpg" loading="lazy" />
                            <FrameCard src="/frame-img_home/oli-woodman-s7gRHGEmX78-unsplash.jpg" loading="lazy" />
                            <FrameCard src="/frame-img_home/f1.webp" loading="lazy" />
                        </div>
                    </div>
                </section>
            </section>
            ...
            <section className='Sunglasses text-white' id="Sunglasses"  style={{ color: 'white' }}>
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="flex flex-wrap -m-4">
                            <FrameCard src="/sunGlassesImages_home/sun_img1.jpg" loading="lazy" />
                            <FrameCard src="/sunGlassesImages_home/sun_img2.jpg" loading="lazy" />
                            <FrameCard src="/sunGlassesImages_home/sun_img3.jpg" loading="lazy" />
                            <FrameCard src="/sunGlassesImages_home/sun_img4.jpg" loading="lazy" />
                            <FrameCard src="/sunGlassesImages_home/sun_img5.jpg" loading="lazy" />
                            <FrameCard src="/sunGlassesImages_home/sun_img6.jpg" loading="lazy" />
                            <FrameCard src="/sunGlassesImages_home/sun_img7.jpg" loading="lazy" />
                            <FrameCard src="/sunGlassesImages_home/sun_img8.jpg" loading="lazy" />
                ...
                <div class="container px-5 py-24 mx-auto flex flex-wrap">
                    <div class="flex flex-wrap md:-m-2 -m-1">
                        <div class="flex flex-wrap w-1/2">
                            <ContactLens src="/contact_lens_home_imgs/alexandru-zdrobau-4bmtMXGuVqo-unsplash.jpg" loading="lazy" />
                            <ContactLens src="/contact_lens_home_imgs/betul-QgUs9t2E3qg-unsplash.jpg" loading="lazy" />
                            <ContactLens src="/contact_lens_home_imgs/furkanvari-WzQIOMM0X-c-unsplash.jpg" className='w-full' loading="lazy" />
                        </div>
                        <div class="flex flex-wrap w-1/2">
                            <ContactLens src="/contact_lens_home_imgs/ismail-hadine-kb96ntPY2CA-unsplash.jpg" className='w-full' loading="lazy" />
                            <ContactLens src="/contact_lens_home_imgs/jonathan-taylor-q_zn_tL-A-A-unsplash.jpg" loading="lazy" />
                            <ContactLens src="/contact_lens_home_imgs/natallia-photo-rfGnikvI0UI-unsplash.jpg" loading="lazy" />
                        </div>
                    </div>
                </div>
            </section>
